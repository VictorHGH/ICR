...
Esta lectura se complementa con la crítica de \citeauthor{rapoport1969} al
determinismo físico: la forma del habitar se define principalmente por
variables socioculturales (valores, organización familiar, prácticas y
simbolismos) y solo de manera secundaria por el clima o los materiales
disponibles.\citep{rapoport1969}  En consecuencia, la tradición
constructiva no puede entenderse como un catálogo de soluciones
\enquote{eficientes} sino como una forma de conocimiento situado,
continuamente reajustada a cambios en prestigios, aspiraciones y
...
Ambos indicadores se integrarán posteriormente en las matrices de lectura
para relacionar la condición material de las construcciones con sus redes
de aprendizaje y uso cotidiano.

...
registro, donde cada variable se vincula a una
...
Desde una perspectiva crítica del patrimonio, estas tensiones también
pueden derivar en procesos de instrumentalización: prácticas y objetos
que se reactivan de manera parcial para responder a agendas externas de
mercado, turismo o legitimación identitaria. En ese sentido,
\citeauthor{i2008zombi} plantea la noción de \enquote{zombi de la
modernidad}, útil para distinguir entre la continuidad viva del saber y
su reutilización descontextualizada \citep{i2008zombi}. Para esta
investigación, esta categoría permitirá interpretar casos donde la
vivienda vernácula se conserva en apariencia material, pero pierde su
función comunitaria y su lógica de transmisión intergeneracional.

De manera complementaria, resulta útil considerar cómo ciertos discursos
institucionales y mediáticos producen y circulan significados que
refuerzan relaciones de poder y jerarquías simbólicas entre materiales y
formas de habitar.  El marco crítico de \citeauthor{thompson1990}
permite analizar operaciones de legitimación, naturalización o
disimulación que, por ejemplo, asocian la tierra con precariedad y el
block con progreso, afectando directamente la jerarquía local de valores
patrimoniales.\citep{thompson1990}
...
\begin{table}[ht]
	...
	\begin{tabular}{@{}L{0.22\linewidth}L{0.35\linewidth}L{0.33\linewidth}@{}}
		...
		recolección}                                                                                  \\
		\midrule
		Uso                   & Presencia y estado de elementos funcionales (fogón, corral, patio)     & Registro fotográfico + fichas descriptivas + entrevistas                  \\
		Estético              & Relatos y descripciones locales sobre la apariencia de la vivienda     & Entrevistas abiertas + registro fotográfico                               \\
		Histórico             & Número de fases constructivas
		identificadas in~situ & Comparación fotográfica + relato de cambios                                              \\
		Antigüedad            & Señales de envejecimiento material y reparaciones sucesivas            & Registro fotográfico + entrevistas                                         \\

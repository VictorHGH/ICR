...
La combinación de estos materiales permite construir un diagnóstico descriptivo y cartográfico, cercano al tipo de productos recurrentes en otras ICR de conservación: fichas, mapas, tipologías y criterios derivados del caso. En esta investigación, esos materiales también alimentarán un catálogo web de consulta, concebido como producto ampliable más allá de las cuatro construcciones iniciales.

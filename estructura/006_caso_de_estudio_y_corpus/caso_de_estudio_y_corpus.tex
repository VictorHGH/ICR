...
El corpus se definió de manera intencional, no estadística. Cada caso debe cumplir cuatro condiciones mínimas: contar con fotografías, tener ubicación interna para análisis cartográfico, estar asociado con al menos un relato o nota de memoria local y representar un sistema constructivo diferenciable dentro del conjunto. Estos criterios son coherentes con el objetivo de producir un diagnóstico verificable y no una muestra representativa de todas las construcciones tradicionales de la región.

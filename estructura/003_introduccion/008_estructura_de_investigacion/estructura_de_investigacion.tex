...
\begin{table}[ht]
  ...
  \begin{tabular}{@{}L{0.28\linewidth}L{0.62\linewidth}@{}}
    ...
    Unidad de análisis & Cuatro construcciones tradicionales documentadas como casos C-01, C-02, C-03 y C-04. \\
...
Esta estructura también define la escala del documento: los resultados no pretenden representar la totalidad de la arquitectura vernácula hñähñu, sino organizar con rigor cuatro casos que permiten reconocer diversidad material, transformaciones recientes y posibilidades de documentación posterior.

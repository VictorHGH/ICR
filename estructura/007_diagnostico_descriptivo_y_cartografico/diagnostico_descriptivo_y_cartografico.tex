...
Esta forma de presentación permite que la evidencia sea verificable y comparable entre casos. También facilita que el diagnóstico pueda consultarse como un conjunto ordenado de fichas independientes, mapas y síntesis comparativas. No se emplea un código único de estado físico, porque ese recurso simplificaría en exceso la condición material, morfológica, social y narrativa de cada construcción. En su lugar, se describe cada caso atendiendo permanencias, adecuaciones, sustituciones, uso y relato asociado.
...
El relato asociado vincula la construcción con la continuidad familiar del raspado de pulque. El informante señaló que antes existían más magueyes en sus magueyales, pero que el consumo local de pulque disminuyó frente a la preferencia por la cerveza. También explicó que las pencas deben reponerse cuando se pudren y que, de acuerdo con enseñanzas familiares, conviene cortarlas después de la luna llena para que duren más tiempo. Así, la construcción no permanece por inmovilidad, sino por mantenimiento activo, conocimiento material y adaptación al uso productivo.
...
El relato permite entender que esas adecuaciones no fueron hechas solo por preferencia formal, sino como respuesta a un problema cotidiano. La familia señaló que los roedores podían entrar en los muros porque la mezcla de lodo era suave y permitía la formación de huecos. Por ello se cubrieron partes del muro con cemento. El caso muestra una tensión entre permanencia morfológica, memoria habitacional y modificación material necesaria para mantener el uso del espacio.
...
El relato de la dueña destaca que la cocina, aunque pequeña, resulta cómoda y adecuada para sus necesidades. También explica un conocimiento específico sobre el manejo del material: los órganos deben trasplantarse después de la luna llena para adaptarse mejor al nuevo sitio, y se debe elegir un tamaño adecuado para que mantengan proporciones semejantes entre sí. La abundancia de órganos en la zona facilita la selección de ejemplares. El caso muestra que la materialidad vegetal no es pasiva; requiere selección, trasplante, mantenimiento y reposición.
...
El resultado no es una jerarquía de valor entre sistemas, sino una descripción ordenada de su diversidad y de las condiciones que explican su permanencia o transformación.
...
Esta síntesis confirma que el producto operativo debe organizar fichas, mapas, fotografías y relatos sin separar la construcción de su uso y de su territorio. También confirma que la publicación debe mantener ubicación generalizada por comunidad, reservar coordenadas exactas para análisis interno y evitar datos personales de propietarios o informantes.

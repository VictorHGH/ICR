...
\begin{enumerate}
	...
	\item qué estructura de ficha y catálogo web permite continuar el registro en etapas posteriores.
\end{enumerate}
...
Los aportes esperados son cuatro. Primero, un registro descriptivo de construcciones tradicionales poco documentadas. Segundo, una tipología inicial de sistemas constructivos persistentes en dos comunidades. Tercero, una base cartográfica y testimonial que permita discutir su valor como patrimonio vernáculo biocultural. Cuarto, una estructura de catálogo web que pueda ampliarse con nuevos registros.

La contribución principal no estará en proponer una intervención arquitectónica, sino en demostrar que estas construcciones todavía contienen información técnica, material y cultural suficiente para justificar su documentación sistemática y su organización en una herramienta pública de consulta.
...
Como líneas de continuidad se plantean la ampliación del catálogo web a más comunidades, la caracterización material de la piedra local denominada ``tepetate'', la comparación temporal con nuevos registros fotográficos y la incorporación progresiva de nuevos sistemas constructivos documentados con la misma ficha base.

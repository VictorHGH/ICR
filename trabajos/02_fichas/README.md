# Fichas por construcción

Cada caso tiene su propia carpeta. Copiar `plantilla_ficha.md` dentro de cada caso o usarla como guía para llenar la información.
...
Primero llenar datos verificables. Después redactar interpretación.
